...
export async function initializeRuntimeRoot(runtimeRoot: string): Promise<void> {
  ...
  for (const relative of ["jobs/pending", "jobs/running", "jobs/completed", "jobs/failed", "staging", "runs", "assessment-staging", "assessments", "decisions", "assessment-decisions", "authorizations", "authorization-state", "deployments", "locks", "locks/decisions", "locks/authorizations"]) {
