...
export interface RejectLifecycleJob extends LifecycleJobBase,VerifiedContextEvidence{action:"reject"}
...
export interface BootstrapLifecycleDecision extends LifecycleDecisionBase{action:"bootstrap_historical_profile";expectedProfileSha256:string;resultingAssignmentId:string}
export interface PromotionLifecycleDecision extends LifecycleDecisionBase,PromotionLifecycleEvidence{action:"promote_selected_model";resultingAssignmentId:string;assessmentId:string;sourceDecisionId:string;authorizationId:string;approvedForecastRunId:string;outcomeId:string;degradationEvidenceId:string;assessmentReferenceCohortId:string;assessmentReferenceDimensionId:string;selectedModelId:"random_forest";selectedModelFamily:"RandomForestRegressor";selectedParameterSha256:string;candidateRegistrySha256:string;featureOrderSha256:string}
export interface RetentionLifecycleDecision extends LifecycleDecisionBase,VerifiedContextEvidence{action:"retain_current_model";resultingAssignmentId:null}
...
export type DeferLifecycleDecision=(LifecycleDecisionBase&{action:"defer";resultingAssignmentId:null;evidenceContextStatus:"explicit_no_evidence"})|(LifecycleDecisionBase&VerifiedContextEvidence&{action:"defer";resultingAssignmentId:null});
export interface RejectLifecycleDecision extends LifecycleDecisionBase,VerifiedContextEvidence{action:"reject";resultingAssignmentId:null}
...
export type LifecycleDecisionCommit=LifecycleDecisionCommitBase&({action:"bootstrap_historical_profile";expectedProfileSha256:string}|({action:"promote_selected_model"}&Omit<PromotionLifecycleEvidence,"expectedDegradationLatestSha256"|"expectedDegradationEvidenceCommitSha256"|"expectedDegradationEvidenceSha256">&{degradationLatestSha256:string;degradationEvidenceCommitSha256:string;degradationEvidenceSha256:string})|({action:"retain_current_model"|"reject"}&VerifiedContextEvidence)|{action:"rollback_previous_assignment";rollbackSourceAssignmentId:string;rollbackSourceAssignmentCommitSha256:string}|{action:"defer";evidenceContextStatus:"explicit_no_evidence"}|({action:"defer"}&VerifiedContextEvidence));
...
export interface BootstrapModelAssignment extends ModelAssignmentBase{assignmentAction:"bootstrap";assignmentReason:"historical_profile_bootstrap";profileRawSha256:string}
...
export interface RollbackModelAssignment extends ModelAssignmentBase{assignmentAction:"rollback";assignmentReason:"controlled_previous_assignment_rollback";rollbackSourceAssignmentId:string;rollbackSourceAssignmentCommitSha256:string}
...
export type ModelAssignmentCommit=ModelAssignmentCommitBase&({assignmentAction:"bootstrap";profileRawSha256:string}|{assignmentAction:"promote";sourceAssessmentCommitSha256:string;sourceDecisionArtifactSha256:string;sourceDecisionCommitSha256:string;sourceAuthorizationRecordSha256:string;sourceAuthorizationCommitSha256:string;sourceAuthorizationConsumptionSha256:string;sourceApprovedForecastCommitSha256:string;sourceOutcomeCommitSha256:string;sourceMonitoringLatestSha256:string;sourceMonitoringSummarySha256:string;sourceMonitoringIncludedOutcomeSetSha256:string;sourceDegradationLatestSha256:string;sourceDegradationEvidenceCommitSha256:string;sourceDegradationEvidenceSha256:string}|{assignmentAction:"rollback";rollbackSourceAssignmentId:string;rollbackSourceAssignmentCommitSha256:string});
export interface ModelAssignmentLatest{schemaVersion:"1.0";deploymentId:"dhaka_south";assignmentId:string;assignmentAction:"bootstrap"|"promote"|"rollback";assignedModelId:"random_forest";modelFamily:"RandomForestRegressor";parameterSha256:string;featureOrderSha256:string;candidateRegistrySha256:string;policyId:"RUNTIME.MODEL_LIFECYCLE.DECISION";policyVersion:"p2-v1";policySha256:string;lifecycleDecisionId:string;lifecycleDecisionCommitSha256:string;assignmentCommitSha256:string;assignmentPath:string;assignmentSha256:string;lifecycleDecisionPath:string;lifecycleDecisionSha256:string;priorAssignmentId:string|null;priorAssignmentCommitSha256:string|null;publishedAt:string;activeModelAuthority:"committed_assignment";automaticAction:false}
