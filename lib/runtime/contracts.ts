...
export interface DegradationEvidenceJobRecord{schemaVersion:"2.0";jobKind:"degradation_evidence";jobId:string;evidenceId:string;deploymentId:"dhaka_south";geography:{level:"city";id:"BGD-DHAKA-SOUTH";name:"Dhaka South"};workflowMode:"degradation_evidence";policyId:"RUNTIME.MODEL_DEGRADATION.EVIDENCE";policyVersion:"p2-v2";policySha256:string;expectedMonitoringLatestSha256:string;expectedMonitoringSummarySha256:string;expectedIncludedOutcomeSetSha256:string;evidenceOnlyAcknowledged:true;status:RuntimeJobStatus;progress:string;createdAt:string;claimedAt:string|null;startedAt:string|null;updatedAt:string;completedAt:string|null;heartbeatAt:string|null;workerId:string|null;processId:number|null;timeoutSeconds:number;retryCount:0;error:{code:string;message:string;retryable:boolean}|null;committedEvidenceId:string|null}
