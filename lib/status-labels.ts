const STATUS_LABELS: Record<string, string> = {
  ...
  decision_recorded: "Governed model decision recorded",
  approved_technical_winner: "Technical winner selected for one run",
  approved_eligible_non_winner: "Governed override selected for one run",
  current_model_retained: "Current assigned model retained for one run",
