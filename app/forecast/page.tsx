    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <header className="mb-7 rounded-2xl border border-border bg-surface p-6">
        ...
        <p className="mt-2 max-w-3xl text-sm text-secondary">
          Upload and authoritatively validate dengue and climate datasets, then run an eligible Quick Forecast or governed temporal dataset assessment. The committed Overview changes only after a complete forecast run commits.
        </p>
        <div className="mt-4 flex gap-2 rounded-xl border border-warning/25 bg-warning/10 p-4 text-sm text-warning">
          <FlaskConical className="h-5 w-5 shrink-0" />
          <p>
            Random Forest is approved only for the current synthetic demonstration context. Materially different datasets require dataset-specific suitability assessment.
          </p>
        </div>
      </header>
      <ForecastRunWorkflow />
