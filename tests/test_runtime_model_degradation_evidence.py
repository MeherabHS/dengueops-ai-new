...
class RuntimeModelDegradationEvidenceTests(unittest.TestCase):
    def test_quick_snapshot_commits_disabled_window_and_is_idempotent(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(snapshot,monitoring_before);self.assertTrue((runtime/"deployments/dhaka_south/degradation/latest_p2-v3.json").exists());self.assertFalse((runtime/"deployments/dhaka_south/degradation/latest.json").exists())
